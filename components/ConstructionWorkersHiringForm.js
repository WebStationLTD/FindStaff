...
const URL_FORM =
  "https://findstaff.admin-panels.com/wp-json/contact-form-7/v1/contact-forms/576/feedback";

export default function ConstructionWorkersHiringForm({ serviceId, serviceName }) {
  ...
  const positionOptions = [
    ...
    "Полагане на пътни настилки",
    "Зидаро-мазачески работи",
    "Шпакловка и боядисване",
    "Армировка и бетонни работи",
    "Монтаж на дограма и врати",
    "Полагане на плочки",
    "Работа с гипсокартон"
  ];
  ...
  async function handleSubmit(e) {
    ...
    formData.append("_wpcf7_unit_tag", "50");
