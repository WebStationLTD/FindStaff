...
const CRITICAL_IMAGES = [
  "/hero-image-mobile-new.jpg", // Hero изображение - мобилна версия
  "/hero-image-desktop-new.jpg", // Hero изображение - десктоп версия
];
  ...
  useEffect(() => {
    ...
    const preloadImages = () => {
      ...
      const priorityImage = isMobile
        ? "/hero-image-mobile-new.jpg"
        : "/hero-image-desktop-new.jpg";
