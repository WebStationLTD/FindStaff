...
const URL_FORM =
  "https://findstaff.admin-panels.com/wp-json/contact-form-7/v1/contact-forms/678/feedback";

export default function DefaultHiringForm({ serviceId, serviceName }) {
  ...
  async function handleSubmit(e) {
    ...
    formData.append("_wpcf7_unit_tag", "DEFAULT");
