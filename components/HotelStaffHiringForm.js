...
const URL_FORM =
  "https://findstaff.admin-panels.com/wp-json/contact-form-7/v1/contact-forms/623/feedback";

export default function HotelStaffHiringForm({ serviceId, serviceName }) {
  ...
  const positionOptions = [
    "Камериерки",
    "Отсервиране",
    "Персонал за СПА център / масажисти",
    "Анимация на деца",
    "Рецепционисти",
    "Обслужване в ресторант",
    "Бармани",
    "Готвачи",
    "Кухненски помощници"
  ];
  ...
  async function handleSubmit(e) {
    ...
    formData.append("_wpcf7_unit_tag", "49");
